...
export async function updateQuotation(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "updateQuotation executado com sucesso",
    ...
    return {
      success: false,
      errors: {
        _form: "Erro ao executar updateQuotation. Tente novamente.",
      },
    };
  }
}
