...
export async function listQuotations(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "listQuotations executado com sucesso",
    ...
    return {
      success: false,
      errors: {
        _form: "Erro ao executar listQuotations. Tente novamente.",
      },
    };
  }
}
