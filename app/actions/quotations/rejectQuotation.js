...
export async function rejectQuotation(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "rejectQuotation executado com sucesso",
    ...
    return {
      success: false,
      errors: {
        _form: "Erro ao executar rejectQuotation. Tente novamente.",
      },
    };
  }
}
