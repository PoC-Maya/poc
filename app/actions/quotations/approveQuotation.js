...
export async function approveQuotation(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "approveQuotation executado com sucesso",
    ...
    return {
      success: false,
      errors: {
        _form: "Erro ao executar approveQuotation. Tente novamente.",
      },
    };
  }
}
