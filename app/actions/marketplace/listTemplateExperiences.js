...
export async function listTemplateExperiences(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "listTemplateExperiences executado com sucesso",
      // Dados adicionais que você queira retornar
    };

  } catch (error) {
    console.error("listTemplateExperiences error:", error);
    return {
      success: false,
      errors: {
        _form: "Erro ao executar listTemplateExperiences. Tente novamente.",
      },
    };
  }
}
