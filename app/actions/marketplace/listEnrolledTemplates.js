...
export async function listEnrolledTemplates(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "listEnrolledTemplates executado com sucesso",
      // Dados adicionais que você queira retornar
    };

  } catch (error) {
    console.error("listEnrolledTemplates error:", error);
    return {
      success: false,
      errors: {
        _form: "Erro ao executar listEnrolledTemplates. Tente novamente.",
      },
    };
  }
}
