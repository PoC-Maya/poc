...
export async function enrollInTemplate(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "enrollInTemplate executado com sucesso",
      // Dados adicionais que você queira retornar
    };

  } catch (error) {
    console.error("enrollInTemplate error:", error);
    return {
      success: false,
      errors: {
        _form: "Erro ao executar enrollInTemplate. Tente novamente.",
      },
    };
  }
}
