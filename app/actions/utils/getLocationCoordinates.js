...
export async function getLocationCoordinates(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "getLocationCoordinates executado com sucesso",
    ...
    return {
      success: false,
      errors: {
        _form: "Erro ao executar getLocationCoordinates. Tente novamente.",
      },
    };
  }
}
