...
export async function validateCoupon(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "validateCoupon executado com sucesso",
    ...
    return {
      success: false,
      errors: {
        _form: "Erro ao executar validateCoupon. Tente novamente.",
      },
    };
  }
}
