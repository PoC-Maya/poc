...
export async function getUnreadNotifications(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "getUnreadNotifications executado com sucesso",
    ...
    return {
      success: false,
      errors: {
        _form: "Erro ao executar getUnreadNotifications. Tente novamente.",
      },
    };
  }
}
