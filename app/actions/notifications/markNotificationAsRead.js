...
export async function markNotificationAsRead(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "markNotificationAsRead executado com sucesso",
    ...
    return {
      success: false,
      errors: {
        _form: "Erro ao executar markNotificationAsRead. Tente novamente.",
      },
    };
  }
}
