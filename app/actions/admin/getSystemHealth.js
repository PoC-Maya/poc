...
export async function getSystemHealth(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "getSystemHealth executado com sucesso",
    ...
    return {
      success: false,
      errors: {
        _form: "Erro ao executar getSystemHealth. Tente novamente.",
      },
    };
  }
}
