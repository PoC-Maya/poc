...
export async function manageLocations(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "manageLocations executado com sucesso",
      // Dados adicionais que você queira retornar
    };

  } catch (error) {
    console.error("manageLocations error:", error);
    return {
      success: false,
      errors: {
        _form: "Erro ao executar manageLocations. Tente novamente.",
      },
    };
  }
}
