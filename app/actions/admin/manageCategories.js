...
export async function manageCategories(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "manageCategories executado com sucesso",
      // Dados adicionais que você queira retornar
    };

  } catch (error) {
    console.error("manageCategories error:", error);
    return {
      success: false,
      errors: {
        _form: "Erro ao executar manageCategories. Tente novamente.",
      },
    };
  }
}
