...
export async function getDashboardStats(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "getDashboardStats executado com sucesso",
    ...
    return {
      success: false,
      errors: {
        _form: "Erro ao executar getDashboardStats. Tente novamente.",
      },
    };
  }
}
