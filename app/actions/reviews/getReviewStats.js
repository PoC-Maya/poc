...
export async function getReviewStats(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "getReviewStats executado com sucesso",
    ...
    return {
      success: false,
      errors: {
        _form: "Erro ao executar getReviewStats. Tente novamente.",
      },
    };
  }
}
