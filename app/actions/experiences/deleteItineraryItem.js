...
export async function deleteItineraryItem(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "deleteItineraryItem executado com sucesso",
    ...
    return {
      success: false,
      errors: {
        _form: "Erro ao executar deleteItineraryItem. Tente novamente.",
      },
    };
  }
}
