...
export async function uploadExperienceImages(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "uploadExperienceImages executado com sucesso",
      // Dados adicionais que você queira retornar
    };

  } catch (error) {
    console.error("uploadExperienceImages error:", error);
    return {
      success: false,
      errors: {
        _form: "Erro ao executar uploadExperienceImages. Tente novamente.",
      },
    };
  }
}
