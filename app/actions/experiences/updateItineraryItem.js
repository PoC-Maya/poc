...
export async function updateItineraryItem(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "updateItineraryItem executado com sucesso",
    ...
    return {
      success: false,
      errors: {
        _form: "Erro ao executar updateItineraryItem. Tente novamente.",
      },
    };
  }
}
