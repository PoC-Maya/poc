...
export async function translateExperience(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "translateExperience executado com sucesso",
      // Dados adicionais que você queira retornar
    };

  } catch (error) {
    console.error("translateExperience error:", error);
    return {
      success: false,
      errors: {
        _form: "Erro ao executar translateExperience. Tente novamente.",
      },
    };
  }
}
