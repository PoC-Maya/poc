...
export async function addItineraryItem(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "addItineraryItem executado com sucesso",
    ...
    return {
      success: false,
      errors: {
        _form: "Erro ao executar addItineraryItem. Tente novamente.",
      },
    };
  }
}
