...
export async function cloneExperience(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "cloneExperience executado com sucesso",
      // Dados adicionais que você queira retornar
    };

  } catch (error) {
    console.error("cloneExperience error:", error);
    return {
      success: false,
      errors: {
        _form: "Erro ao executar cloneExperience. Tente novamente.",
      },
    };
  }
}
