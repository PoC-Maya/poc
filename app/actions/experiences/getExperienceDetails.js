...
export async function getExperienceDetails(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "getExperienceDetails executado com sucesso",
      // Dados adicionais que você queira retornar
    };

  } catch (error) {
    console.error("getExperienceDetails error:", error);
    return {
      success: false,
      errors: {
        _form: "Erro ao executar getExperienceDetails. Tente novamente.",
      },
    };
  }
}
