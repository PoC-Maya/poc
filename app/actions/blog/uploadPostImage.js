...
export async function uploadPostImage(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "uploadPostImage executado com sucesso",
    ...
    return {
      success: false,
      errors: {
        _form: "Erro ao executar uploadPostImage. Tente novamente.",
      },
    };
  }
}
