...
export async function addTimeBlock(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "addTimeBlock executado com sucesso",
      // Dados adicionais que você queira retornar
    };

  } catch (error) {
    console.error("addTimeBlock error:", error);
    return {
      success: false,
      errors: {
        _form: "Erro ao executar addTimeBlock. Tente novamente.",
      },
    };
  }
}
