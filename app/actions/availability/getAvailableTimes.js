...
export async function getAvailableTimes(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "getAvailableTimes executado com sucesso",
    ...
    return {
      success: false,
      errors: {
        _form: "Erro ao executar getAvailableTimes. Tente novamente.",
      },
    };
  }
}
