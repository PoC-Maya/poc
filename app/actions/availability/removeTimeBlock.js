...
export async function removeTimeBlock(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "removeTimeBlock executado com sucesso",
      // Dados adicionais que você queira retornar
    };

  } catch (error) {
    console.error("removeTimeBlock error:", error);
    return {
      success: false,
      errors: {
        _form: "Erro ao executar removeTimeBlock. Tente novamente.",
      },
    };
  }
}
