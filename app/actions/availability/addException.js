...
export async function addException(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "addException executado com sucesso",
      // Dados adicionais que você queira retornar
    };

  } catch (error) {
    console.error("addException error:", error);
    return {
      success: false,
      errors: {
        _form: "Erro ao executar addException. Tente novamente.",
      },
    };
  }
}
