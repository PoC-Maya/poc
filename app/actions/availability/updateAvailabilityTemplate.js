...
export async function updateAvailabilityTemplate(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "updateAvailabilityTemplate executado com sucesso",
      // Dados adicionais que você queira retornar
    };

  } catch (error) {
    console.error("updateAvailabilityTemplate error:", error);
    return {
      success: false,
      errors: {
        _form: "Erro ao executar updateAvailabilityTemplate. Tente novamente.",
      },
    };
  }
}
