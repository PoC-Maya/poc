...
export async function getAvailableDates(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "getAvailableDates executado com sucesso",
    ...
    return {
      success: false,
      errors: {
        _form: "Erro ao executar getAvailableDates. Tente novamente.",
      },
    };
  }
}
