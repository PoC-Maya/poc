...
export async function removeException(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "removeException executado com sucesso",
      // Dados adicionais que você queira retornar
    };

  } catch (error) {
    console.error("removeException error:", error);
    return {
      success: false,
      errors: {
        _form: "Erro ao executar removeException. Tente novamente.",
      },
    };
  }
}
