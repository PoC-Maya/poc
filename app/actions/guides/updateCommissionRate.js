...
export async function updateCommissionRate(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "updateCommissionRate executado com sucesso",
    ...
    return {
      success: false,
      errors: {
        _form: "Erro ao executar updateCommissionRate. Tente novamente.",
      },
    };
  }
}
