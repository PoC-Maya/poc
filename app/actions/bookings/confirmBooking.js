...
export async function confirmBooking(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "confirmBooking executado com sucesso",
    ...
    return {
      success: false,
      errors: {
        _form: "Erro ao executar confirmBooking. Tente novamente.",
      },
    };
  }
}
