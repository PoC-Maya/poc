...
export async function sendBookingConfirmation(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "sendBookingConfirmation executado com sucesso",
    ...
    return {
      success: false,
      errors: {
        _form: "Erro ao executar sendBookingConfirmation. Tente novamente.",
      },
    };
  }
}
