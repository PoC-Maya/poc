...
export async function completeBooking(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "completeBooking executado com sucesso",
    ...
    return {
      success: false,
      errors: {
        _form: "Erro ao executar completeBooking. Tente novamente.",
      },
    };
  }
}
