...
export async function getBookingDetails(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "getBookingDetails executado com sucesso",
    ...
    return {
      success: false,
      errors: {
        _form: "Erro ao executar getBookingDetails. Tente novamente.",
      },
    };
  }
}
