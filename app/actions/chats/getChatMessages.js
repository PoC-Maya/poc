...
export async function getChatMessages(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "getChatMessages executado com sucesso",
    ...
    return {
      success: false,
      errors: {
        _form: "Erro ao executar getChatMessages. Tente novamente.",
      },
    };
  }
}
