...
export async function getRevenueReport(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "getRevenueReport executado com sucesso",
    ...
    return {
      success: false,
      errors: {
        _form: "Erro ao executar getRevenueReport. Tente novamente.",
      },
    };
  }
}
