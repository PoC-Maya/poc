...
export async function getExperiencePerformanceReport(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "getExperiencePerformanceReport executado com sucesso",
      // Dados adicionais que você queira retornar
    };

  } catch (error) {
    console.error("getExperiencePerformanceReport error:", error);
    return {
      success: false,
      errors: {
        _form: "Erro ao executar getExperiencePerformanceReport. Tente novamente.",
      },
    };
  }
}
