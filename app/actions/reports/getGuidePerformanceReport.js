...
export async function getGuidePerformanceReport(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "getGuidePerformanceReport executado com sucesso",
      // Dados adicionais que você queira retornar
    };

  } catch (error) {
    console.error("getGuidePerformanceReport error:", error);
    return {
      success: false,
      errors: {
        _form: "Erro ao executar getGuidePerformanceReport. Tente novamente.",
      },
    };
  }
}
