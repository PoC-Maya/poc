...
export async function getBookingReport(prevState, formData) {
  try {
    ...
    return { 
      success: true,
      message: "getBookingReport executado com sucesso",
    ...
    return {
      success: false,
      errors: {
        _form: "Erro ao executar getBookingReport. Tente novamente.",
      },
    };
  }
}
